...
const App = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      image: projectt3,
      description:
        'A MERN based GYM project focuss onn security with jwt session cookie, used qr generation validation and authentication',
      languages: "React, Tailwind , Node,  Express, MongoDB",
